...
<main>
        ...
        <div class="container-jumbo">
            <div class="container">
                ...
                <h2 class="display-4">Merupakan program keahlian yang membekali peserta didik dengan 
                    ...
                    <br>
                    menginstall program, merawat dan memperbaiki komputer serta jaringan.</h2>
  ...
  <section id="content">
            <div class="container mt-5">
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <p class="text-left">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magni numquam explicabo nemo enim consequatur nam esse doloremque dolor voluptate eos, sunt officiis saepe ea? Atque eum inventore culpa tempore doloremque.</p>
                  </div>
                </div>
        </div>
        ...
        <div class="container mt-5">
          ...
          {{-- <h6 class="text-body-secondary fw-lighter">Pembelajaran Teknik Komputer & Jaringan</h6> --}}
        ...
        <div class="card-group">
          ...
          <div class="card me-2" style="width: 15rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Guru Mapel : <br><span class="text-body-secondary">Dasar Kejuruan TKJ<br>Komputer dan Jaringan Dasar</span></p>
          ...
          <div class="card me-2" style="width: 15rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Pengajar TKJ</p>
              <p class="card-text">Guru Mapel : <br><span class="text-body-secondary">Adminitrasi Infastruktur Jaringan<br>Teknologi Layanan Jaringan<br>PWD</span></p>
            </div>
          </div>
          ...
          <div class="card me-2" style="width: 15rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Guru Mapel : <br><span class="text-body-secondary">Dasar Desain Grafis<br>Dasar Keahlian TJKT</span></p>
