            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mx-auto p-2">
                    <li class="nav-item me-3">
                        <a class="nav-link {{ Request::segment(1) === 'home' ? 'active' : null }}" aria-current="page"
                            href="/home">Beranda</a>
                    </li>
                    <li class="nav-item me-3">
                        <a class="nav-link {{ Request::segment(1) === 'learning' ? 'active' : null }}"
                            href="{{ route('learning.index') }}">E-Learning</a>
                    </li>
                    <li class="nav-item me-3">
