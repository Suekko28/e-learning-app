...
@section('navbar')
    <main>
        <div class="container mt-5">
            ...
            <img src="{{ asset('storage/public/images/'.$learning->image) }}" class="img-fluid mx-auto d-block" width="500px   "
                height="500px" alt="...">
            ...
            <div class="col text-right">
                ...
                <a class="btn text-white fw-bold" href="{{ $learning->drive }}"
                    style="background-color: #1A205D" target="_blank">Download Materi</a>
            </div>
            ...
            <div class="row justify-content-start">
                @foreach ($latest as $item)
                    <div class="card mt-2 me-2 border border-0 shadow rounded mb-2" style="width: 20rem">
                        <img src="{{ asset('storage/public/images/'.$item->image) }}" class="card-img-top img-fluid mt-2"
