        ...
        <section class="content">
          <div class="container-fluid">
            <!-- Small boxes (Stat box) -->
                <form action="{{url('/admin/materi', $data->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                    <div class="card-body container">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="thumbnail" name="drive" placeholder="Masukkan Link Drive" value="{{$data->drive}}">
                     </div>
