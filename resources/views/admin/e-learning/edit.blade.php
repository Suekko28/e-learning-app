                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0 fw-bold">Edit Materi</h1>
                                </div><!-- /.col -->
                                <div class="col-sm-6">
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            <form action="{{ url('/admin/materi', $data->id) }}" method="post"
                                ...
                                <div class="card-body container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control" id="content" name="content" placeholder="Masukkan Isi Materi">{{ $data->content }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="thumbnail">Thumbnail</label>
                                        <input type="text" class="form-control" id="thumbnail" name="thumbnail"
                                            placeholder="Masukkan Thumbnail" value="{{ $data->thumbnail }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="thumbnail">Link Drive</label>
                                        <input type="text" class="form-control" id="thumbnail" name="drive"
                                            placeholder="Masukkan Link Drive" value="{{ $data->drive }}">
                                    </div>
