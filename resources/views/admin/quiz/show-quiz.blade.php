                                ...
                                <div class="text-left"><!--opening of div tag-->
                                    ...
                                    @foreach ($allQuiz as $quiz)
                                        <div class="number-quiz">
                                            {{ $loop->iteration . '. ' }}
                                            <a href="/admin/quiz/{{ $quiz->id }}/edit"><i
                                                    class="ml-3 fas fa-pen text-warning"></i></a>
                                            <form action="/admin/quiz/{{ $quiz->id }}" method="POST"
                                                class="d-inline">
                                                @method('DELETE')
                                                @csrf
                                                <button class="border-0 bg-transparant d-inline"
                                                    style="background-color: transparent;"
                                                    onclick="return confirm(`Hapus quiz ini?`);"><i
