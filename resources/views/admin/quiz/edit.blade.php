                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" class="form-control" id="option_a"
                                                    name="option_a" value="{{ $quiz->option_a }}" required>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <div class=" card p-2">
                                                    <div class="form-check">
                                                        <input type="radio" id="option_true" name="option_true"
                                                            value="option_a"
                                                            @if ($quiz->option_true == 'option_a') {{ 'checked' }} @endif>
                                                        <label for="option_a">Jawaban A</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" id="option_true" name="option_true"
                                                            value="option_b"
                                                            @if ($quiz->option_true == 'option_b') {{ 'checked' }} @endif>
                                                        <label for="option_b">Jawaban B</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" id="option_true" name="option_true"
                                                            value="option_c"
                                                            @if ($quiz->option_true == 'option_c') {{ 'checked' }} @endif>
                                                        <label for="option_c">Jawaban C</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" id="option_true" name="option_true"
                                                            value="option_d"
                                                            @if ($quiz->option_true == 'option_d') {{ 'checked' }} @endif>
