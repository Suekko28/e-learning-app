            ...
            <div class="wrapper">
                ...
                <aside class="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    <a href="index3.html" class="brand-link">
                        <img src="/logo_tkj.jpg" alt="TKJ Logo" class="brand-image img-circle elevation-3"
                            style="opacity: .8">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col text-body-secondary text-lighter">
                                    <a href="{{ url('/admin/act/create') }}"
                                        class="btn btn-success  mb-3 text-white"><i class="fa-solid fa-plus"></i>
                                        Kegiatan</a>
                                </div>
                                <div class="col d-flex justify-content-end">
                                    <form action="{{ route('search.admin.kegiatan') }}" class="d-flex form-inputs w-50"
                                        ...
                                        <input value="{{ old('search.admin.kegiatan') }}" class="form-control"
                                            type="text" name="search" placeholder="Masukan Judul Kegiatan"
                                            aria-label="Search">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <a href="{{ url('/admin/act/' . $item->id) . '/edit' }}"
                                                        class="btn btn-warning mb-2"><i
                                                            class=" fa fa-solid fa-pen-to-square"
                                                            style="color:white;"></i></a>
                                                    <form action="{{ url('/admin/act/' . $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
