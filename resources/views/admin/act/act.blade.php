      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <a href="{{url('/admin/kegiatan/create')}}" class="btn btn-success  mb-3 text-white"><i class="fa-solid fa-plus"></i>  Kegiatan</a>
            <div class="row">
                ...
                <table class="table table-bordered vw-100 ">
                  ...
                  <tbody>
                    ...
                    @foreach ($data as $item)
                      ...
                      <td scope="row">
                        <a href="{{url('/admin/kegiatan/'. $item->id) .'/edit'}}" class="btn btn-warning mb-2"><i class=" fa fa-solid fa-pen-to-square" style="color:white;"></i></a>
