                ...
                <div class="content-wrapper">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ url('admin/act') }}">Kegiatan</a></li>
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            <form action="{{ url('/admin/act', $data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body container">
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        <a href="{{ url('/admin/act') }}" class="btn btn-danger">Batal</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
